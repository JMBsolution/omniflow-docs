...
- Accredited Investors as defined in Section 4A of the Singapore Securities and Futures Act
...
- A person prohibited from receiving the Services under any applicable law
...
The Services may be unavailable from time to time due to maintenance, technical issues, regulatory requirements, or events outside OmniFlow's control. OmniFlow does not warrant uninterrupted availability of the Services.

## 4. User Obligations

### 4.1 Compliance with Laws

You are solely responsible for compliance with all laws applicable to your access to and use of the Services, including securities laws, tax laws, anti-money laundering laws, and sanctions laws of your jurisdiction of residence and citizenship.

### 4.2 Wallet Security

You are solely responsible for the security of your wallet, private keys, and any credentials used to access the Services. OmniFlow does not custody your wallet keys and cannot recover lost keys or unauthorized transfers from your wallet.
...
- Use the Services for any unlawful purpose, including money laundering or sanctions evasion

- Attempt to bypass eligibility gating, lock-up restrictions, or other protocol-level controls

- Provide false information or impersonate another person or entity

- Operate AI Agents outside the scope of authorized KYA permissions

- Reverse engineer, decompile, or attempt to extract source code from the Services beyond what is permitted under applicable open-source licenses

- Engage in market manipulation, front-running, or coordinated trading aimed at distorting NAV or secondary market prices

- Use the Services to facilitate offerings to ineligible persons
...
- Investment in OmniFlow products carries material risk, including risk of partial or total loss of principal
...
OmniFlow does not provide investment, legal, tax, or other professional advice. Information published in the documentation, the website, or other channels is for general information only and does not constitute a recommendation to buy, sell, or hold any product.

### 8.2 No Warranty

The Services are provided "as is" and "as available," without warranty of any kind. OmniFlow disclaims all warranties, express and implied, including warranties of merchantability, fitness for a particular purpose, and non-infringement, except where such disclaimer is prohibited by law.
...
- OmniFlow's aggregate liability under or in connection with these Terms is limited to the lesser of (a) the fees you have paid to OmniFlow in the 12 months preceding the claim, or (b) USD 100,000

- OmniFlow is not liable for indirect, incidental, special, consequential, exemplary, or punitive damages

- These limitations apply regardless of the form of action and even if OmniFlow has been advised of the possibility of such damages

The limitations in this Section do not apply where prohibited by applicable law, including consumer protection laws applicable in your jurisdiction.

## 10. Indemnification

You agree to indemnify, defend, and hold harmless OmniFlow, its affiliates, and their respective directors, officers, employees, and agents from any claim, loss, damage, liability, or expense (including reasonable legal fees) arising out of:
...
- Operation of an AI Agent outside the scope of authorized KYA permissions

## 11. Suspension and Termination

OmniFlow may suspend or terminate your access to the Services, in whole or in part, with or without notice, where:

- Required by applicable law, regulation, or order of a court or competent authority

- Necessary to address suspected fraud, sanctions risk, or material adverse compliance event

- You materially breach these Terms

- Continued access poses material risk to OmniFlow, its counterparties, or other users

Suspension or termination does not relieve you of obligations accrued prior to the suspension or termination.

## 12. Dispute Resolution

### 12.1 Governing Law

These Terms are governed by the laws of Singapore, without reference to conflict-of-law principles.

### 12.2 Arbitration

Any dispute arising out of or in connection with these Terms shall be referred to and finally resolved by arbitration administered by the Singapore International Arbitration Centre (SIAC) in accordance with the SIAC Rules in force at the time of submission. The seat of arbitration shall be Singapore. The tribunal shall consist of one arbitrator. The language of the arbitration shall be English.

### 12.3 Carve-Outs

Nothing in this Section limits OmniFlow's right to seek injunctive or equitable relief in any court of competent jurisdiction to protect its intellectual property or to prevent ongoing harm pending arbitration.

## 13. Miscellaneous

### 13.1 Entire Agreement

These Terms, together with the documents incorporated by reference (including the Privacy Policy, the Risk Disclosure, and the Disclaimers), constitute the entire agreement between you and OmniFlow regarding the Services.
...
No failure or delay by OmniFlow in exercising any right under these Terms operates as a waiver of that right.

### 13.5 Assignment

You may not assign these Terms without OmniFlow's prior written consent. OmniFlow may assign these Terms to an affiliate or successor in connection with corporate restructuring, financing, or similar events.
